...
public class FieldItems {
	...
	public FieldItems(String dbNameField, String loginField, String passwordField, String scriptFolderField, String ipAddressField, String port) {
		if (dbNameField != null) {
	...
	public static FieldItems createFromConfig(ConfigUtil config) throws Exception {
		...
		FieldItems items =
					new FieldItems(propConf.getString(ConfigUtil.DB_NAME), propConf.getString(ConfigUtil.DB_USER), propConf.getString(ConfigUtil.DB_PASS),
								propConf.getString(ConfigUtil.SCRIPT_FOLDER), propConf.getString(ConfigUtil.DB_IP), propConf.getString(ConfigUtil.PORT));
