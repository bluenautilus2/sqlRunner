...
public class DBRowRetriever {
    ...
    public ArrayList<SqlScriptRow> readDataBase() throws Exception {
        ...
        try {
            ...
            connect = DriverManager
                    .getConnection(this.getConnectString(), fields.getLoginField(), fields.getPasswordField());
            ...
            resultSet = statement
                    .executeQuery("select * from system_db_updates order by db_update_date desc");
    ...
    private String getConnectString() throws Exception {
        ...
        buff.append(fields.getIpAddressField() + ":1433;DatabaseName=");
